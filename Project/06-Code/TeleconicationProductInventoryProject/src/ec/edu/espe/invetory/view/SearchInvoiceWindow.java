 ...
 */
public class SearchInvoiceWindow extends javax.swing.JFrame {

    /**
     * Creates new form SearchInvoiceWindow
     */
    public SearchInvoiceWindow() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchInvoiceWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchInvoiceWindow().setVisible(true);
            }
        });
    }
